...
UpgradeMurkyWater.prototype = Object.create(Upgrade.prototype);
...
* @method updateCost
*/
UpgradeMurkyWater.prototype.updateCost = function() {
...
*/
UpgradeMurkyWater.prototype.specificUpgrades = function() {
	switch(this.currentLevel) {
		case 0:
