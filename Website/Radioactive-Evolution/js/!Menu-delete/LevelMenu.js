/**
* Menu shown in between levels, allowing the user to continue to the next level
* or purchase an evolutionary upgrade with their XP.
*
* @class LevelMenu
* @extends Menu
* @constructor
...
LevelMenu.prototype = Object.create(Menu.prototype);
...
*/
LevelMenu.prototype.mouseMovedActions = function() {
...
*/
LevelMenu.prototype.getUpgradeInstance = function(upgradeName) {
...
*/
LevelMenu.prototype.getUpgradeDescription = function(upgrade) {
...
*/
LevelMenu.prototype.mouseClicked = function(mouseX,mouseY) {
	for(var i = 0; i < this.buttons.length; i++) {
		if(this.buttons[i].isSelected()) {
			if(this.buttons[i].getKey() === "nextLevel") {
				notification = null;
...
*/
LevelMenu.prototype.checkButtonVisibility = function() {
	for(var i = 0; i < this.buttons.length; i++) {
		if(this.buttons[i].getKey() != "nextLevel") {
